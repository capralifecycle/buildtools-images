...
def dockerImageName = '923402097046.dkr.ecr.eu-central-1.amazonaws.com/buildtools/ecs-deploy'
  ...
  dockerNode {
    ...
    if (env.BRANCH_NAME == 'master' && !isSameImage) {
      stage('Push Docker image') {
        ...
        slackNotify message: "New Docker image available: ecs-deploy:$tagName"
      }
    }
  }
}
