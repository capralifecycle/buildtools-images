...
def dockerImageName = '923402097046.dkr.ecr.eu-central-1.amazonaws.com/buildtools/serverless'
...
buildConfig([
  ...
  githubUrl: 'https://github.com/capralifecycle/serverless-docker/',
  slack: [
  ...
  dockerNode {
    ...
    if (env.BRANCH_NAME == 'master' && !isSameImage) {
      stage('Push Docker image') {
        ...
        slackNotify message: "New Docker image available: serverless-docker:$tagName"
      }
    }
  }
}